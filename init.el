...
(doom! :input
       ...
       (dired            ; making dired pretty [functional]
        ;; +ranger          ; ranger's cool, but this package is buggy and looks unmaintained
        +icons)          ; already using it with ivy, so w/ever
       electric          ; smarter, keyword-based electric-indent
       (ibuffer          ; interactive buffer management
        +icons)          ; icons for everyone...
       ...
       (spell            ; tasing you for misspelling mispelling
         +flyspell       ; spell-fu doesn't like non-english for now?
         +hunspell)      ; hunspell > aspell (or is it?)
       ...
       (lsp              ; M-x vscode
        +peek)           ; Take a gander at Tweeks a...
       (magit            ; a git porcelain for Emacs
        +forge)          ; want to work in a forge!
       ...
       gitlab            ; .gitlab-ci support, maybe more in the future
       ;;verb              ; TODO
